/**
 * @typedef {import('../../lib/cartographTypes').TransferManifestTelemetry} TransferManifestTelemetry
 * @typedef {import('../../lib/cartographTypes').TransferStateQueueTelemetry} TransferStateQueueTelemetry
 */
